...
ofVideoPlayer::~ofVideoPlayer(){
	...
	//--------------------------------------
		...
		//ICHANGEDTHISif ((offscreenGWorld)) DisposeGWorld((offscreenGWorld));
...
void ofVideoPlayer::createImgMemAndGWorld(){
	...
	//ICHANGEDTHISLockPixels(GetGWorldPixMap(offscreenGWorld));
	//ICHANGEDTHISSetGWorld (offscreenGWorld, NULL);
